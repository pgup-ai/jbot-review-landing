...
assets/
  logo.png      # J-Bot brand mark (source, 512x512)
...
- Brand mark and favicons use the J-Bot logo. The OG card (`og.png`) is a
  separate composed 1200x630 image and is left unchanged.
