...
- **Engineering · Faster reviews, part 1 of 5** — [Why AI code review is slow](https://www.pgupai.com/guides/why-ai-code-review-is-slow): Two-thirds of the reviewer’s turns were lookups, tools took 1.8% of the time, and the model route swung reviews 20-fold. (Published Sep 24, 2026)
- **Engineering · Faster reviews, part 2 of 5** — [21 ways we tried to make AI code review faster](https://www.pgupai.com/guides/ai-code-review-speed-experiments): Smarter retrieval, caching, and telling the model to do less mostly failed. Removing whole sessions and predictable lookups worked. (Published Sep 24, 2026)
- **Engineering · Faster reviews, part 3 of 5** — [Context packs: how we made AI code review faster](https://www.pgupai.com/guides/context-pack-ai-code-review): The code a reviewer predictably looks up, delivered before its first turn, and the four details that made it work. (Published Sep 24, 2026)
- **Engineering · Faster reviews, part 4 of 5** — [AI code review that reads your team’s coding rules](https://www.pgupai.com/guides/ai-code-review-team-guidelines): Guideline files were cut at 24 KB. Now the sections that name the changed files come first, and a missed rule gets quoted. (Published Sep 24, 2026)
- **Engineering · Faster reviews, part 5 of 5** — [Faster AI code review: the before-and-after numbers](https://www.pgupai.com/guides/faster-ai-code-review-results): Turns down 30 to 45%, production reviews in 73 to 98 seconds on a fast route, and caught issues within run-to-run noise. (Published Sep 24, 2026)
