...
- **Engineering · Faster reviews, part 1 of 5** — [Why AI code review is slow](https://www.pgupai.com/guides/why-ai-code-review-is-slow): Two-thirds of the reviewer’s turns were lookups. Running the tools took 1.8% of the time. (Published Sep 24, 2026)
...
- **Engineering · Integrations** — [How we added Jev, a relevance model, to AI code review](https://www.pgupai.com/guides/jev-relevance-ranking-code-review): One HTTPS call decides which callers the reviewer sees. It cut review cost 16% on the test PR with the most candidates, with no clear gain on a small one. (Published Sep 24, 2026)
